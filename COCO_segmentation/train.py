...
PIN_MEMORY = True
LOAD_MODEL = True
TRAIN_IMG_DIR = 'coco/images/train2017'
TRAIN_MASK_DIR = 'coco/images/train_masks/'
VAL_IMG_DIR = 'coco/images/val2017'
VAL_MASK_DIR = 'coco/images/val_masks/'

def train_fn(loader, model, optimizer, loss_fn, lr_scheduler, scaler):
    loop = tqdm(loader)
    for batch_index, (data, targets) in enumerate(loop):
        ...
        with torch.cuda.amp.autocast():
            ...
            loss = loss.mean() # Ajoute pour enlever le scaler
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        train_fn(train_loader, model, optimizer, loss_fn, lr_scheduler, scaler) 
